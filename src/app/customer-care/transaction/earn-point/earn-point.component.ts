...
@Component({
  selector: 'earn-point-component',
  templateUrl: './earn-point.component.html',
  styleUrls: ['./earn-point.component.scss']
})

export class EarnPointComponent {
  ...
  @ViewChild('modalCreateEditPoint') public modalCreateEdiPoint: ModalDirective;
